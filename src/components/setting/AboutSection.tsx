...
function TwitterFeed() {
  ...
  const links = useMemo(
    () => [
      ...
      {
        title: t("about.links.extension"),
        label: t("about.links.browserAddon"),
        bucket: "bottom",
        href: "https://holodex.net/extension",
        icon: Puzzle,
      },
    ],
    [t],
  ...
  const statCards = useMemo(() => {
    ...
    return [
      {
        label: t("about.stats.vtubers"),
        value: s.channelCount.vtuber || 0,
        delta: t("about.stats.lastMonth", { count: s.monthlyChannels.vtuber || 0 }),
      },
      {
        label: t("about.stats.subbers"),
        value: s.channelCount.subber || 0,
        delta: t("about.stats.lastMonth", { count: s.monthlyChannels.subber || 0 }),
      },
      {
        label: t("about.stats.videos"),
        value: s.totalVideos.count || 0,
        delta: t("about.stats.yesterday", { count: s.dailyVideos.count || 0 }),
      },
  ...
  return (
    <div ref={elRef} className="space-y-4 p-5">
      {s ? (
        <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
          {statCards.map((item) => (
            <Card key={item.label} role="article" size="sm">
              <div className="text-2xl font-normal" data-stat-value data-value={item.value}>
                0
              </div>
      ...
      <section className="px-5">
        ...
        <div className="about-credits mt-4 space-y-4 text-sm leading-6 text-muted-foreground">
          <p>
            ...
            <a
              className="font-medium text-primary underline underline-offset-4 transition-opacity hover:opacity-90"
          ...
          <p>
            {t("about.youtubeTerms.before")}{" "}
            <a
              className="font-medium text-primary underline underline-offset-4 transition-opacity hover:opacity-90"
              href="https://www.youtube.com/t/terms"
            >
              {t("about.youtubeTerms.link")}
            </a>
            {t("about.youtubeTerms.after")}
          </p>
        </div>
      </section>
      <section className="px-5">
        ...
        <div className="mt-4">
          <Accordion multiple>
            <Faq title={t("about.faq.ytchatHeader")}>
            ...
            <Faq title={t("about.faq.autoplayHeader")}>
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  <div>
                    <div className="mb-2 text-sm font-normal text-foreground">Safari</div>
                    <img
                      width="80%"
                  ...
                  <div>
                    <div className="mb-2 text-sm font-normal text-foreground">Firefox</div>
                    <img
                      width="80%"
            ...
            <Faq title={t("about.faq.mobile.title")}>
              <p>{t("about.faq.mobile.content.summary")}</p>
              <ul className="mt-3 space-y-2 pl-5">
                <li>
                  {t("about.faq.mobile.content.android.0")} <MoreVertical className="size-4 mx-1" />{" "}
                  {t("about.faq.mobile.content.android.1")}
                </li>
                <li>
                  {t("about.faq.mobile.content.ios.0")} <Share className="size-4 mx-1" />{" "}
                  {t("about.faq.mobile.content.ios.1")}
                </li>
              </ul>
            </Faq>
            <Faq title={t("about.faq.favorite.disappear.title")}>
              {t("about.faq.favorite.contents.0")}
            </Faq>
            <Faq title={t("about.faq.subber.title")}>
            ...
            <Faq title={t("about.faq.support.title")}>
              <div dangerouslySetInnerHTML={{ __html: t.raw("about.faq.support.contents.0") }} />
            </Faq>
            <Faq title={t("about.privacyPolicy")}>
              <PrivacyPolicy />
            </Faq>
            <Faq title={t("about.gdpr")}>
              {t("about.gdprContent")}{" "}
              <span className="font-normal text-foreground">{t("about.gdprDeletion")}</span>
            </Faq>
          </Accordion>
        </div>
      </section>
...
function Faq({ title, children }: { title: React.ReactNode; children: React.ReactNode }) {
  return (
    <AccordionItem value={String(title)}>
      ...
      <AccordionContent className="text-sm leading-6 text-muted-foreground [&_a]:font-medium [&_a]:text-primary [&_a]:underline [&_a]:underline-offset-4">
        {children}
      </AccordionContent>
    </AccordionItem>
  );
    ...
    <div className="space-y-4">
      ...
      <div>
        <h4 className="text-base font-normal text-foreground">
          {t("about.privacy.firstParty.title")}
        </h4>
        <p className="mt-2">{t("about.privacy.firstParty.collection")}</p>
        <p className="mt-2">{t("about.privacy.firstParty.voluntary")}</p>
        <p className="mt-2">{t("about.privacy.firstParty.access")}</p>
        <p className="mt-2">{t("about.privacy.firstParty.limitedUse")}</p>
        <p className="mt-2">{t("about.privacy.firstParty.noPosting")}</p>
        <p className="mt-2">{t("about.privacy.firstParty.revoking")}</p>
        <p className="mt-2">{t("about.privacy.firstParty.changes")}</p>
      </div>
      <div>
        <h4 className="text-base font-normal text-foreground">
          {t("about.privacy.thirdParty.title")}
        </h4>
        <h5 className="mt-3 text-sm font-normal uppercase tracking-[0.18em] text-foreground">
          {t("about.privacy.thirdParty.analyticsTitle")}
        </h5>
        <p className="mt-2">{t("about.privacy.thirdParty.analyticsBody")}</p>
        <p className="mt-2">{t("about.privacy.thirdParty.analyticsUse")}</p>
        <h5 className="mt-3 text-sm font-normal uppercase tracking-[0.18em] text-foreground">
          {t("about.privacy.thirdParty.embedsTitle")}
        </h5>
        <p className="mt-2">{t("about.privacy.thirdParty.embedsBody")}</p>
        <p className="mt-2">{t("about.privacy.thirdParty.linksIntro")}</p>
        <h5 className="mt-3 text-sm font-normal uppercase tracking-[0.18em] text-foreground">
          {t("about.privacy.thirdParty.choicesTitle")}
        </h5>
        <p className="mt-2">{t("about.privacy.thirdParty.choicesBody")}</p>
        <h5 className="mt-3 text-sm font-normal uppercase tracking-[0.18em] text-foreground">
          {t("about.privacy.thirdParty.contactTitle")}
        </h5>
        <p className="mt-2">{t("about.privacy.thirdParty.contactBody")}</p>
        <p className="mt-2">{t("about.privacy.thirdParty.commitment")}</p>
        <div className="space-y-2">
          <a
            className="block text-primary underline underline-offset-4"
            href="https://policies.google.com/privacy"
          >
            {t("about.privacy.links.google")}
          </a>
          <a
            className="block text-primary underline underline-offset-4"
            href="https://www.twitch.tv/p/en/legal/privacy-notice/"
          >
            {t("about.privacy.links.twitch")}
          </a>
        </div>
      </div>
    </div>
