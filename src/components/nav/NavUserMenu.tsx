...
export function useNavUserMenu() {
  ...
  const initialQueryForCalendar =
    app.currentOrg.name !== ALL_VTUBERS_ORG
      ? [{ type: "org", text: app.currentOrg.name, value: app.currentOrg.name }]
      : false;
      ...
      {!user ? (
          ...
          <div className="space-y-3" onClick={(e) => e.stopPropagation()}>
            {allowedOAuthHost ? (
              ...
              <Button
                ...
                disabled
                title={t("component.userMenu.googleSignInUnavailable")}
              >
                <GoogleIcon className="size-4" />
                <span>{t("views.login.with.0")}</span>
              </Button>
            )}
            <Button variant="outline" className="w-full justify-center" onClick={loginDiscord}>
            ...
            {showManualOAuth ? (
              <div className="space-y-2 text-left" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="flex gap-2">
                  <Button size="sm" onClick={submitManualOAuth}>
                    {t("component.mainNav.login")}
                  </Button>
                  <Button
                    variant="secondary"
        ...
        <>
            ...
            <div className="px-3 pb-2" onClick={(e) => e.stopPropagation()}>
              {allowedOAuthHost ? (
                ...
                <Button
                  ...
                  className="w-full justify-center"
                  disabled
                  title={t("component.userMenu.googleLinkUnavailable")}
                >
                  <GoogleIcon className="size-3.5" />
                  <span>{t("component.userMenu.linkGoogle")}</span>
                </Button>
          ...
          <div className="space-y-2 px-3 pb-2" onClick={(e) => e.stopPropagation()}>
            ...
            <Button variant="secondary" size="sm" onClick={resetApiKey}>
          ...
          <div className="px-3 pb-2" onClick={(e) => e.stopPropagation()}>
            <CalendarUsage initialQuery={initialQueryForCalendar as any} />
          </div>
        </>
      )}
    </PopoverContent>
