...
export function VideoCardList({ videos = [], includeChannel = false, includeAvatar = false, hideThumbnail = false, denseList = false, horizontal = false, autoFit = false, autoFill = false, autoFitMin = "13rem", max = undefined, className = "", cols = { xs: 1, sm: 2, md: 3, lg: 4, xl: 5 }, activeId = "", dense = false, disableDefaultClick = false, filterConfig = {}, sortFn, showComments = false, inMultiViewSelector = false, fadeUnderNavExt = false, onVideoClicked, renderAction }: any) {
  ...
  }, [app.windowWidth, horizontal, denseList, autoFit, autoFill, cols.xs, cols.sm, cols.md, cols.lg, cols.xl]);
  const list = useMemo(() => {
