...
export default defineComponent({
    ...
    data: function () {
        return {
            ...
            layouts: {} as Record<string, any>, // store all layouts from different breakpoints
            lastBreakpoint: null as string | null, // store last active breakpoint
            originalLayout: null as any[] | null, // store original Layout
        };
    },
    created() {
        const self = this;
        ...
        self.resizeEventHandler = function (eventType: string, i: any, x: number, y: number, h: number, w: number) {
            self.resizeEvent(eventType, i, x, y, h, w);
        };

        self.dragEventHandler = function (eventType: string, i: any, x: number, y: number, h: number, w: number) {
