      ...
      {!loggedIn ? (
        ...
        <div className="grid gap-6 xl:grid-cols-[0.9fr_0.9fr_1.5fr]">
          <Card className="flex min-h-[32rem] flex-col p-4">
            <div className="border-b px-2 pb-3 text-center text-lg font-semibold">{t("views.relayBot.servers")}</div>
          ...
          {selectedGuildData ? (
            <Card className="flex min-h-[32rem] flex-col p-4">
              <div className="border-b px-2 pb-3 text-center text-lg font-semibold">{selectedGuildData.bot ? t("views.relayBot.channelsFor", { name: selectedGuildData.name }) : selectedGuildData.name}</div>
          ...
          {selectedChannelData ? (
            <Card className="space-y-6 p-5">
              <div><h2 className="text-lg font-semibold">{t("views.relayBot.settingFor", { name: selectedChannelData.name })}</h2></div>
              ...
              <section className="space-y-3 border-t pt-6">
                <h3 className="text-sm font-semibold text-muted-foreground">{t("views.relayBot.relaySubscription")}</h3>
