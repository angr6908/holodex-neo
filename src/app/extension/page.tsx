...
export default function ExtensionPage() {
  ...
  useEffect(() => {
    document.title = `${t("views.extension.title")} - Holodex`;
  }, [t]);
  ...
  return (
    <div className="mx-auto min-h-screen w-full max-w-[1600px] px-3 pb-10 pt-[var(--nav-total-height,120px)] sm:px-5 flex max-w-6xl flex-col gap-6">
      ...
      >
        <a
          href="https://chrome.google.com/webstore/detail/holodex-plus/mjcecbpccklceljomllkhilglcdcncbh"
          title={t("views.extension.chromeWebstore")}
          className="inline-flex"
        >
          <img
            src="/img/holodex-plus/chrome-webstore.png"
            alt={t("views.extension.chromeWebstore")}
            className="max-h-[50px] max-w-[180px] rounded-xl object-contain"
          />
        </a>
        <a
          href="https://addons.mozilla.org/firefox/addon/holodex-plus/"
          title={t("views.extension.firefoxExtension")}
          className="inline-flex"
        >
          <img
            src="/img/holodex-plus/firefox-amo.png"
            alt={t("views.extension.firefoxAddons")}
            className="max-h-[50px] max-w-[145px] rounded-xl object-contain"
          />
        </a>
        <Button
          nativeButton={false}
          render={
            <a
              ...
              title={t("views.extension.githubDownload")}
              rel="noopener"
            />
          }
        ...
        >
          ...
          {t("views.extension.installFromGithubPrefix")}
          <br />
          {t("views.extension.installFromGithubSuffix")}
        </Button>
      </ExtensionPromoCard>
      ...
      >
        <Button
          ...
          render={
            <a
              target="_blank"
              href="https://www.raycast.com/uetchy/holodex"
              title={t("views.extension.raycastStore")}
              rel="noopener"
            />
          }
          className="h-[50px] px-4"
        >
          <img
            src="https://www.raycast.com/assets/static/favicon.b9532cc.628b74797b5186d6caec6476f06179e0.png"
            alt="Raycast"
            className="mr-2 h-8 w-8 rounded-md"
          />
          {t("views.extension.raycast.getItOnPrefix")}
          <br />
          {t("views.extension.raycast.getItOnSuffix")}
        </Button>
        <Button
          nativeButton={false}
          render={
            <a
              target="_blank"
              href="https://github.com/HolodexNet/raycast-holodex"
              title={t("views.extension.downloadSourceCode")}
              rel="noopener"
            />
          }
          className="h-[50px] px-4"
