    ...
    <section className="mx-auto flex min-h-screen w-full max-w-[1600px] flex-col px-5 pb-10 pt-[calc(var(--nav-header-height,56px)+0.75rem)] sm:px-8 lg:px-10 xl:px-12">
      ...
      <div className="channel min-h-[85vh] py-3">
        {tab === "about" ? (
          ...
          <ChannelVideos channel={channel} tab={tab} id={id} />
        )}
      </div>
    </section>
  );
  ...
  const controls = (
    <div className="flex items-center gap-1">
      <Button
        ...
        title={
          sortOrder === "desc"
            ? t("views.channels.sort.newestFirst")
            : t("views.channels.sort.oldestFirst")
        }
      ...
      <Button
        ...
        onClick={() => app.setCurrentGridSize((gs + 1) % 3)}
      >
        {(() => {
          const C = gridIcon;
